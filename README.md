...
```
● sudo apt update && sudo apt upgrade : updates the package list and upgrades the installed packages to their latest versions
● sudo apt search package_name        : searches repositories for packages related to the one provided
● sudo apt show package_name          : displays detailed info about the package provided
